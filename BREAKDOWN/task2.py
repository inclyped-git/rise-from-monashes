"""
The program will convert amount of Dusts to appropriate Dorabie, Doubloon, and remaining
Dusts amounts.    
"""
...
dustToDorabie_rate = (dustToDoubloon_rate * doubloonToDorabies_rate) # getting the dust to dorabie rate
