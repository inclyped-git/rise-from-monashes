...
"""
# takes in three numbers; later converts the string numbers into integer data type, and stdore them in a list.
...
while ( len(listOfBerylDollars) != 3 ):
    # prints the appropriate error message; and re-asks the user to input three numbers.
